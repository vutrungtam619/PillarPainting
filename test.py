...
from utils import setup_seed, read_points, read_calib, read_label, \
    ...
    bbox_camera2lidar
from model import PillarPainting, BiSeNetV2
...
def main(args):
    ...
    with torch.no_grad():
        ...
        result_filter = model(batched_pts=[pc_torch], batched_image_paths = [args.img_path], batched_calibs = [calib_info], mode='test')[0]
